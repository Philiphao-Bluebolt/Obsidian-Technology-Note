...
In the first part, the optimal policy is obtained by iteratively solving BOE and BE, assuming full knowledge of the transition and reward probability model. However, its's difficult to gain full knowledge about the environment model. 
